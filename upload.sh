...
aws s3 rm s3://amir-knowledge-base-for-word-prediction/withCombiners/step1output --recursive
aws s3 rm s3://amir-knowledge-base-for-word-prediction/withCombiners/step4output --recursive
aws s3 rm s3://amir-knowledge-base-for-word-prediction/withCombiners/step5output --recursive
aws s3 rm s3://amir-knowledge-base-for-word-prediction/withCombiners/step6output --recursive
